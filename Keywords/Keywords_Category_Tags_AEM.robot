...
AEM_Category_Tags_01_Step07 Click Create
    ...
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_01.PNG
    sleep  3s
AEM_Category_Tags_01_Step07 Validate Category Tag on Properties
    ...
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_01_Properties.PNG
    sleep  1s
AEM_Category_Tags_01_Step08 Check API Personalization
    ...
    sleep  2s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_01_API.PNG
    sleep  3s
...
AEM_Category_Tags_02_Step06 Save&close
    ...
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_02.PNG
    sleep  3s
AEM_Category_Tags_02_Step07 Validate Category Tag on Properties
    ...
    sleep  3s
    Capture Page Screenshot              ${date_today}_AEM_Category_Tags_02_Properties.PNG
    sleep  3s
AEM_Category_Tags_02_Step08 Check API Personalization
    ...
    sleep  3s
   Capture Page Screenshot          ${date_today}_AEM_Category_Tags_02_API.PNG
    sleep  3s
...
AEM_Category_Tags_03_Step06 Input value in Basic tab
    ...
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_03_No_match.PNG
    sleep  3s
AEM_Category_Tags_03_Step07 Click Create
    ...
    Switch Window     title=STAGE | AEM Editor
    sleep  3s
    Capture Page Screenshot             ${date_today}_AEM_Category_Tags_03.PNG
    sleep  3s
AEM_Category_Tags_03_Step08 Validate Category Tag on Properties
    ...
    Click Element Wait AEM           ${tab_edit_Category Tag_AEM}
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_03_Properties.PNG
    sleep  1s
AEM_Category_Tags_03_Step09 Check API Personalization
    ...
    sleep  1s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_03_API.PNG
    sleep  3s
...
AEM_Category_Tags_04_Step07 Click Create
    sleep  5s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_04.PNG
    sleep  3s
...
AEM_Category_Tags_05_Step09 Save&close
    ...
    Click Element Wait AEM           ${btn_save&close_category_tag_AEM}
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_05.PNG
    sleep  3s
AEM_Category_Tags_05_Step10 Validate Category Tag on Properties
    ...
    Click Element Wait AEM           ${tab_edit_Category Tag_AEM}
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_05_Properties.PNG
    sleep  3s
AEM_Category_Tags_05_Step11 Check API Personalization
    ...
    sleep  3s
   Capture Page Screenshot          ${date_today}_AEM_Category_Tags_05_API.PNG
    sleep  3s
...
AEM_Category_Tags_06_Step08 Save&close
    ...
    Click Element Wait AEM           ${btn_save&close_category_tag_AEM}
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_06.PNG
    sleep  3s
AEM_Category_Tags_06_Step09 Validate Category Tag on Properties
    ...
    Click Element Wait AEM           ${tab_edit_Category Tag_AEM}
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_06_Properties.PNG
    sleep  3s
AEM_Category_Tags_06_Step08 Check API Personalization
    ...
    sleep  3s
   Capture Page Screenshot          ${date_today}_AEM_Category_Tags_06_API.PNG
    sleep  3s
AEM_Category_Tags_06_Roll Back
    ...
    sleep  3s
    Click Element Wait AEM           ${Click_Tag_Food Grocery_AEM}
    sleep  3s
    Click Element Wait AEM           ${btn_save&close_category_tag_AEM}
    sleep  3s
...
AEM_Category_Tags_07_Step09 Validate Category Tag on Properties
    ...
    Click Element Wait AEM           ${tab_edit_Category Tag_AEM}
    sleep  3s
    Capture Page Screenshot        ${date_today}_AEM_Category_Tags_07_Properties.PNG
    sleep  3s
AEM_Category_Tags_07_Step10 Check API Personalization
    Go To           https://uatlibrary.the1.co.th/the1/personalized/offers/recommended.recommendedOffers.json?t1xNum=0&segment=P_Rec_EatAround&segmentNum=16&partnerNum=0
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_07_API.PNG
    sleep  3s
...
AEM_Category_Tags_08_Step06 Input value in Basic tab
    ...
    sleep  3s
    Click Element Wait AEM     ${Click_Tag Restaurant}
    sleep  1s
...
AEM_Category_Tags_08_Step07 Click Create
    ...
    Switch Window     title=STAGE | AEM Editor
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_08.PNG
    sleep  3s
AEM_Category_Tags_08_Step07 Validate Category Tag on Properties
    ...
    Click Element Wait AEM           ${tab_edit_Category Tag_AEM}
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_08_Properties.PNG
    sleep  1s
...
AEM_Category_Tags_09_Step07 Click Create
    ...
    Switch Window     title=STAGE | AEM Editor
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_Created_09.PNG
    sleep  3s
AEM_Category_Tags_09_Step08 Validate Category Tag on Properties
    ...
    Click Element Wait AEM           ${tab_edit_Category Tag_AEM}
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_Created_Properties_09.PNG
...
AEM_Category_Tags_09_Step10 Validate Category Tag Deleted
    ...
    Click Element Wait AEM              ${tab_edit_Category Tag_AEM}
    sleep  3s
    Capture Page Screenshot          ${date_today}_AEM_Category_Tags_09.PNG
    sleep  1s
