...
Create Campaign 3Transfer on SMP
    ...
    Click Element Wait SMP                   ${input_tags}
    Input Text                      ${input_tags}     BDG_${date_today}_${Name_Badge_01}_inprogress;;604800
...
Create Campaign 3Redeem on SMP
    ...
    Click Element Wait SMP                   ${btn_advanced2}
    Click Element Wait SMP                   ${input_tags}
    Input Text                      ${input_tags}           BDG_${date_today}_${Name_Badge_05}_inprogress;;604800
    Click Element Wait SMP                   ${btn_OK2}
    sleep  4s
    Click Element Wait SMP                   ${btn_Save2}
    sleep  8s
...
Badge_AEM_01 Step03 Click Badge Category page under the 1 Central
    ...
    sleep  3s
    Click Element Wait AEM          ${folder_Badge_Category}
    sleep  2s
    Click Element Wait AEM          ${btn_create_AEM}
    sleep  2s
    Click Element Wait AEM           ${btn_page_AEM}
    Click Element Wait AEM           ${foder_Card_Badge_Category}
    Click Element Wait AEM           ${btn_Next_page}
Badge_AEM_01 Step06 Input Title Name > Click Create
    ...
    Click Element Wait AEM                ${btn_create_badge_title_AEM}
    Click Element Wait AEM           ${btn_open_badge_title_AEM}
    sleep  7s
...
Badge_AEM_01 Step08 Click Edit Badge Category > Click Configure
    Click Element Wait AEM                ${Click edit}
    sleep  2s
    Double Click Element AEM       ${btn_edit_badge_AEM}
    sleep  2s
Badge_AEM_01 Step09 Input Badge Category Information Click Done
    ...
    Click Element Wait AEM               ${input_Image_Category_TH_Light}
    Input information AEM           ${input_Image_Category_TH_Light}    /content/dam/badge-category/L_Public.png
    Click Element Wait AEM               ${input_Image_Category_TH_Click}
    ...
    Click Element Wait AEM               ${input_Image_Category_EN_Light}
    ...
    sleep  2s
    Click Element Wait AEM               ${input_Category_Order}
    Input information AEM           ${input_Category_Order}     1
    Click Element Wait AEM               ${btn_Done}
    sleep  2s
Badge_AEM_01 Step11 Click Preview > Click Submit
    Double Click Element AEM       ${btn_Preview_Page_Badge_AEM}
    Select Frame                    xpath=//iframe[@id='ContentFrame']
    Click Element Wait AEM               ${btn_Submit_Preview_Page_Cat_AEM}
    sleep  3s
    Reload Page
    sleep  8s
...
Badge_AEM_03 Step08 Click Edit Badge V2 > Click Configure
    Click Element Wait AEM                ${btn_Edit_Badge}
    sleep  4s
    Double Click Element AEM        ${btn_edit_badge_AEM}
    sleep  4s
Badge_AEM_03 Step09 Input Badge V2 Information Click Done
    ...
    sleep    1s
    Click Element Wait AEM             ${select_Partner_the1}
    Input information AEM         ${input_campaignID}                   ${CampaignID1}
    # Input information AEM         ${input_campaignID}                   12055
    Click Element Wait AEM             ${btn_Retrieve Campaign Details}
    sleep  8s
    ...
    Click Element Wait AEM              ${select Behavior Goal Type}
    Select list Wait AEM          ${select count}
    Click Element Wait AEM              ${Outcome Type}
    ...
    Click Element Wait AEM             ${Tab_Thai}
    ...
    Click Element Wait AEM             ${Tab_English}
...
Badge_AEM_03 Step11 Click Preview > Click Submit
    ...
    Select Frame    xpath=//iframe[@id='ContentFrame']
    sleep  4s
    Click Element Wait AEM     ${btn_Submit_Preview_Page_badge_AEM}
    sleep  4s
    Reload Page
    sleep  4s
    Click Element Wait AEM     ${btn_complete_Approve flow_badge_AEM}
    sleep  2s
    Click Element Wait AEM      ${btn_complete_ok_Approve flow_badge_AEM}
    sleep  3s
    Reload Page
    sleep  3s
    Reload Page
...
Badge_AEM_04 Step11 Click Preview > Click Submit
    ...
    Select Frame            xpath=//iframe[@id='ContentFrame']
    sleep  4s
    Click Element Wait AEM      ${btn_Submit_Page_Spent_AEM}
    sleep  4s
    Reload Page
    sleep  4s
    Click Element Wait AEM     ${btn_complete_Approve flow_badge_AEM}
...
Badge_AEM_06 Step09 Input Badge V2 Information Click Done
    ...
    sleep   1s
    Click Element Wait AEM             ${select_Partner_B2S}
    # Input information AEM         ${input_campaignID}                   12054
...
Badge_AEM_08 Step07 Edit Badge Category Information
    Double Click Element AEM       ${btn_edit_cate_AEM}
    sleep  4s
